...
var config : Dictionary = {
	"supabaseUrl": "https://jxpjdkhcwvqobvcwaokd.supabase.co",
	"supabaseKey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp4cGpka2hjd3Zxb2J2Y3dhb2tkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjUzMzg2OTQsImV4cCI6MjA4MDkxNDY5NH0.wOASv9dKaFdY7SVlNzixHPkEZzKqao8Ez3m2_zJg6w4"
}
